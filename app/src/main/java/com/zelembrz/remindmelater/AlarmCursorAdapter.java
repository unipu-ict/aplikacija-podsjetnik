...
public class AlarmCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (date != null){
            ...
            mDateAndTimeText.setText("Datum nije postavljen");
        }

        if(repeat != null){
            setReminderRepeatInfo(repeat, repeatNo, repeatType);
        }else{
            mRepeatInfoText.setText("Ponavljanje nije postavljeno");
        }
    ...
    // Postavljanje naslova podsjetnika
    ...
    // Postavljanje prikaza datuma i vremena
    public void setReminderDateTime(String datetime) {
        mDateAndTimeText.setText(datetime);
    }

    // Postavite ponavljanje prikaza
    public void setReminderRepeatInfo(String repeat, String repeatNo, String repeatType) {
        if(repeat.equals("true")){
            mRepeatInfoText.setText("Every " + repeatNo + " " + repeatType + "(s)");
        }else if (repeat.equals("false")) {
            mRepeatInfoText.setText("Ponavljanje iskljuceno");
        }
    }

    // Postavite aktivnu sliku kao uključenu ili isključenu
